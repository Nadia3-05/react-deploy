    ...
    return (
        <div className="main">
            <div className="main__box">
                <div className="main__box__avatar">
                ...
                <div className="main__box__post">
                    <div className="main__date"> {item.getDate()} </div>
                    <div className="main__description"> {item.description} </div>
                    <div className="main__image"> {item.image} </div>
